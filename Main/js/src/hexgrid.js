...
function GetHexagon(innerRadius, outerRadius, material) {
...
var Hexgrid = function(innerRadius, outerRadius, width, depth) {	
	
	this.group = new THREE.Object3D();
	this.width = width;
	this.depth = depth;
	this.material = new THREE.MeshPhongMaterial({ color: 0x777777, side: THREE.DoubleSide });	
	...
	for (var i = 0; i < depth; i++) {
		...
		for (var j = 0; j < width; j++) {
			...
			var mesh = GetHexagon(innerRadius, outerRadius, this.material);
